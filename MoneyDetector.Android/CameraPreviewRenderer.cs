...
[assembly: ExportRenderer(typeof(MoneyDetector.CameraPreview), typeof(CameraPreviewRenderer))]
namespace MoneyDetector.Droid {
    public class CameraPreviewRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer {
        ...
        protected override void Dispose(bool disposing) {
            ...
            if (disposing) {
                ...
                if (Element != null) {
                    ...
                    if (Platform.GetRenderer(Element) == this) Platform.SetRenderer(Element, null);
                }
            }
        ...
        void IVisualElementRenderer.SetElement(VisualElement element) {
            ...
            if (visualElementTracker == null) visualElementTracker = new VisualElementTracker(this);

            Element = camera;
        }

        void IVisualElementRenderer.SetLabelFor(int? id) {
            if (defaultLabelFor == null) defaultLabelFor = id;
